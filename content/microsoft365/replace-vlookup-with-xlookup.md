---
site: "m365-work"
title: "VLOOKUPの列番号指定が面倒ならXLOOKUPに変えるべき？3人の実例で検証"
...
hypothesis: "XLOOKUPへ置き換えることで参照式を読みやすくできるケースがある"
...
# VLOOKUPの列番号指定が面倒ならXLOOKUPに変えるべき？3人の実例で検証

## 結論

列番号・検索方向・列挿入時の弱点に対し、XLOOKUPへ切り替える利点を3件確認した。
