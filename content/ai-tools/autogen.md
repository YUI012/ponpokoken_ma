...
| 事例 | 詳細 |
|---|---|
| 1 | **やったこと**：GroupChatを実装<br>**結果**：複数エージェントが会話<br>**前提・環境**：AutoGen<br>**参考になる点**：最小構成は実装しやすい |
| 2 | **やったこと**：Rustビルドを実行<br>**結果**：Function Callingで外部処理<br>**前提・環境**：AutoGen＋Function Calling<br>**参考になる点**：会話以外へ拡張可能 |
| 3 | **やったこと**：マルチエージェントを実行<br>**結果**：基本動作を確認<br>**前提・環境**：AutoGen<br>**参考になる点**：更新頻度と不安定さに注意 |
