...
|---|---|---|---|---|
| 1 | S3文書でRAGを構築 | 検索・回答まで動作 | Bedrock Knowledge Bases | PoCの入口が軽い |
| 2 | Knowledge Baseを実装 | RAGの一連の流れを確認 | AWS / Bedrock | 初学者でも進めやすい |
| 3 | 社内規定を検索対象に投入 | 抽象的な質問にも回答 | Knowledge Base | 社内文書検索に近い |
