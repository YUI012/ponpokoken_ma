...
| 事例 | 詳細 |
|---|---|
| 1 | **やったこと**：iOS画面実装を依頼<br>**結果**：手直しありで短時間に実装<br>**前提・環境**：VS Code＋Cline＋Xcode<br>**参考になる点**：試作速度が高い |
| 2 | **やったこと**：ClineからRoo Codeへ移行<br>**結果**：躓きが一部解消<br>**前提・環境**：VS Code＋ローカルLLM<br>**参考になる点**：ツール差で体験が変わる |
| 3 | **やったこと**：ClineをVS Codeへ導入<br>**結果**：AIチャットとの往復を削減<br>**前提・環境**：VS Code＋Cline<br>**参考になる点**：エディタ内で完結しやすい |
