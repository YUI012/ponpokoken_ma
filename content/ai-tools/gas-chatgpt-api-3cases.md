...
| 事例 | やったこと | 結果 | 環境 | 参考になる点 |
|---|---|---|---|---|
| 1 | GASからChatGPT APIを呼び出し | サーバー不要で実行 | Googleアカウント | 小さく始めやすい |
| 2 | スプレッドシート長文を要約 | 一括要約ツールを作成 | Sheets＋GAS | 反復作業を減らせる |
| 3 | AIからLINEへ通知 | 自発通知Botを作成 | GAS＋OpenAI＋LINE | 回答だけでなく通知へ拡張 |
