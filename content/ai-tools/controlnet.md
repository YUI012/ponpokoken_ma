...
| 事例 | 詳細 |
|---|---|
| 1 | **やったこと**：OpenPoseでポーズ固定<br>**結果**：方向は近づくがズレあり<br>**前提・環境**：ComfyUI＋ControlNet<br>**参考になる点**：完全固定ではない |
| 2 | **やったこと**：Cannyで構図維持<br>**結果**：色・顔・画角を変更<br>**前提・環境**：Stable Diffusion＋Canny<br>**参考になる点**：構図維持に便利 |
| 3 | **やったこと**：マネキンから人物画像生成<br>**結果**：衣服ディテールを保持<br>**前提・環境**：Web UI＋ControlNet<br>**参考になる点**：元画像構造を活用 |
