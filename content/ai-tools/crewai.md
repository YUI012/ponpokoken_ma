...
| 事例 | 詳細 |
|---|---|
| 1 | **やったこと**：検索・評価・レポート生成を分担<br>**結果**：助成金リストを作成<br>**前提・環境**：CrewAI＋検索ツール<br>**参考になる点**：役割分担は実装可能 |
| 2 | **やったこと**：QuickStartを実行<br>**結果**：複数エージェントの動作確認<br>**前提・環境**：CrewAI CLI<br>**参考になる点**：最小構成を試しやすい |
| 3 | **やったこと**：ローカルLLMで複数Agent<br>**結果**：プロンプト生成を実行<br>**前提・環境**：CrewAI＋LM Studio<br>**参考になる点**：クラウドAPIなしでも構成可能 |
