...
3例の共通点は、CI/CDや開発工程へセキュリティ検査を組み込んでいる、自動化と継続的なフィードバックを重視していることです。

一方で、SAST単独とSAST/DAST/SCA統合で成熟度が異なる、AWS中心とGitHub Actions中心で構成が異なるため、同じ手順をそのまま当てはめるのではなく、対象と目的を先に決める必要があります。
